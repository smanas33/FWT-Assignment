...
public class ScreenServiceImplTest {
	...
	public void addScreen_ShouldThrowException_WhenNullScreenObjectGiven() {		
		Screen screen = null;
	...
	@Test
	public void addScreen_MoreThanFourScreenObjectGiven_ShouldThrowScreenSizeException() {	
		Screen screen = new Screen(100, "Screen1");
		when(screenDAO.getAllScreen()).thenReturn(Arrays.asList(new Screen(200, "Screen2"),new Screen(300, "Screen3"),new Screen(400, "Screen4")));
		int rowAdded = screenService.addScreen(screen);
